"""
GeneradorMatematicas - Servicio para generar ejercicios de matemáticas personalizados
...
class GeneradorMatematicas:
    """
    Generador de ejercicios de matemáticas personalizados usando Gemini AI
    """
    ...
    def __init__(
        ...
        """
        Inicializa el generador de matemáticas
    ...
    def generar_ejercicios(
        ...
        """
        Genera ejercicios de matemáticas personalizados para un estudiante

        Args:
            estudiante_id: ID del estudiante
            cantidad: Cantidad de ejercicios a generar (1-20)
            tipo_especifico: Tipo de ejercicio específico (suma, resta, etc.)
        ...
        if forzar_nivel:
            ...
            nivel = prompt_builder.determinar_nivel_desde_perfil(perfil, "matematicas")
        ...
        prompt = prompt_builder.construir_prompt_matematicas(
            nivel=nivel,
            cantidad=cantidad,
        ...
        return {
            ...
            "curso": CursoEnum.MATEMATICAS.value,
            "cantidad_solicitada": cantidad,
            "cantidad_generada": len(ejercicios),
            "ejercicios_matematicas": ejercicios,
            "ejercicios_verbales": None,
    ...
    def _validar_ejercicios(
        ...
        Returns:
            Lista de objetos EjercicioMatematicas validados
        """
    ...
    def _determinar_tipo_por_nivel(self, nivel: str) -> str:
        ...
        """
        tipos_por_nivel = {
            "basico": ["suma", "resta", "conteo", "comparacion"],
            "intermedio": ["multiplicacion", "division", "fracciones", "problemas_mixtos"],
            "avanzado": ["operaciones_combinadas", "porcentajes", "geometria_avanzada", "proporciones"]
        }

        # Retornar el primer tipo para ese nivel
        return tipos_por_nivel.get(nivel, ["suma"])[0]
    ...
    def generar_por_tipo(
        ...
        print(f"\n📚 Generando {len(tipos)} tipos de ejercicios...")
        ...
        for tipo in tipos:
            try:
                ...
                todos_ejercicios.extend(resultado["ejercicios_matematicas"])
        ...
        return {
            ...
            "ejercicios_matematicas": todos_ejercicios,
            "ejercicios_verbales": None,
            "perfil_usado": self._preparar_perfil_respuesta(perfil),
            "nivel_determinado": prompt_builder.determinar_nivel_desde_perfil(perfil, "matematicas"),
...
if __name__ == "__main__":
    # Test del GeneradorMatematicas
    print("=" * 70)
    print("TEST: GeneradorMatematicas")
    print("=" * 70)
    ...
    try:
        ...
        print("\n🧪 Test 1: Generar 3 ejercicios de suma (nivel automático)")
        ...
        if resultado["ejercicios_matematicas"]:
            primer_ejercicio = resultado["ejercicios_matematicas"][0]
            print(f"\n📝 Primer ejercicio generado:")
            print(f"  ID: {primer_ejercicio.id}")
            print(f"  Título: {primer_ejercicio.titulo}")
            print(f"  Enunciado: {primer_ejercicio.enunciado[:100]}...")
        ...
        print("\n" + "=" * 70)
        print("✅ GeneradorMatematicas funcionando correctamente")
        print("=" * 70)
